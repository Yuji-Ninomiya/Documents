...
delta1000 = '\delta_3=100';
delta2000 = '\delta_3=1000';
delta5000 = '\delta_3=10000';
...
for n = 1:6
    ...
    if n==1
        ...
        legend('refference model','\delta_3=100','\delta_3=1000','\delta_3=10000','Location','southeast')
    elseif n==2
        fig.Name = 'error';
    ...
    hold off
    filename = sprintf('/home/kazuhiro/Documents/院授業/車両制御特論/tominaga/report2/matlab/fig/delta3_%s.eps',fig.Name);
